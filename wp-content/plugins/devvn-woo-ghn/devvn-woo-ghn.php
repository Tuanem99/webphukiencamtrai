<?php
/*
 * Plugin Name: DevVN - Woocommerce - Giao Hàng Nhanh (GHN)
...
class DevVN_Woo_GHN_Class
{
    ...
    function custom_override_checkout_fields( $fields ) {
        if(!$this->get_options('alepay_support')) {
            ...
            $fields['billing']['billing_last_name'] = array(
                'label' => __('Full name', 'devvn-ghn'),
                'placeholder' => _x('Type Full name', 'placeholder', 'devvn-ghn'),
                'required' => true,
        ...
        $fields['billing']['billing_state'] = array(
            ...
            'placeholder'	=> _x('Select Province/City', 'placeholder', 'devvn-ghn'),
            'options'   	=> array( '' => __( 'Select Province/City', 'devvn-ghn' ) ) + $this->tinh_thanhpho,
            'priority'  =>  30
        );
        if(!$this->get_options()) {
            $fields['billing']['billing_city'] = array(
                'label' => __('Commune/Ward/Town', 'devvn-ghn'),
                'required' => true,
                'type' => 'select',
                'class' => array('form-row-wide', 'address-field', 'update_totals_on_change'),
                'placeholder' => _x('Select Commune/Ward/Town', 'placeholder', 'devvn-ghn'),
                'options' => array(
                    '' => ''
                ),
                'priority' => 40
        ...
        $fields['billing']['billing_address_1']['placeholder'] = _x('Ex: No. 20, 90 Alley', 'placeholder', 'devvn-ghn');
        ...
        $fields['shipping']['shipping_phone'] = array(
            'label' => __('Phone', 'devvn-ghn'),
            'placeholder' => _x('Phone', 'placeholder', 'devvn-ghn'),
            'required' => false,
        ...
        $fields['shipping']['shipping_address_1']['placeholder'] = _x('Ex: No. 20, 90 Alley', 'placeholder', 'devvn-ghn');
    ...
    function devvn_woocommerce_admin_billing_fields($billing_fields){
        ...
        $billing_fields = array(
            ...
            'city' => array(
                'label' => __( 'Xã phường', 'woocommerce' ),
                'class'   => 'js_field-city select short',
                'type'      =>  'select',
                'show'  => false,
                'options' => array( '' => __( 'Chọn xã/phường&hellip;', 'woocommerce' ) ) + $this->get_list_wards_select($city),
            ),
            'address_1' => array(
    ...
    function devvn_woocommerce_admin_shipping_fields($shipping_fields){
        ...
        $billing_fields = array(
            ...
            'city' => array(
                ...
                'type'      =>  'select',
                'show'  => false,
                'options' => array( '' => __( 'Chọn quận/huyện&hellip;', 'woocommerce' ) ) + $this->get_list_wards_select($city),
            ),
            'address_1' => array(
                'label' => __( 'Address line 1', 'woocommerce' ),
                'show'  => false,
